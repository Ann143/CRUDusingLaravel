...
<style>
    ...
    body{
      background-image:url(https://c4.wallpaperflare.com/wallpaper/669/150/555/anime-music-headphones-guitar-anime-girls-wallpaper-preview.jpg);
...
<div class="card push-top" style="height: 465px">
  ...
  <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
            <p  style="font-size:20px;color:white">Add User</p>
            </div>
